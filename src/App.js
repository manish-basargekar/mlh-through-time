			...
			<div className={Style.container}>
				...
				<div className={Style.sidebar}>
					{/* <div className={Style.content}>
						{data.map((item, index) => {
							return (
								<div key={index} className={Style.sidebarItem}>
									<div className={Style.sidebarItemDate}>{item.date}</div>
									<div className={Style.sidebarItemTitle}>{item.title}</div>
									<div className={Style.sidebarItemDescription}>
										{item.description}
									</div>
								</div>
							);
				...
				{/* <div className={Style["sm-circle"]}>
					<div className={Style.circle1}>
						<div className={Style["circle2"]}></div>
					</div>
				</div> */}
				{/* <div className={Style.bigRedButton}>BIG RED BUTTON</div> */}
				<div className={Style["bottom-bar"]}>
					{/* <div className={Style.terminal}>
						<p>
							I dont which commands they run on time machines, so I am gonna
							just write whatever, just assume this is a real time machine
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error,
							corporis sint? Eaque placeat iure odit recusandae quaerat iusto
							error, aliquam quidem deleniti, quasi rerum dignissimos laudantium
							nulla consequatur ullam cupiditate.
						</p>
						<p>
							wow, you are still reading, jkasbdasdagsdasjhdv auisdasbdasbd :)
							<span>|</span>
						</p>
					</div> */}
				</div>
				<div className={Style.header}>
					<div className={Style.marquee}>
						<div>
							<span>
								Buckle in to ensure pilot safety Buckle in to ensure pilot
								safety  Buckle in to ensure pilot safety  
							</span>
